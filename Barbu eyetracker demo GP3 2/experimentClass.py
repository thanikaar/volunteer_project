...
class Experiment:
    def __init__(self,
        ...
        # Store the actual detected screen resolution now, while the window
        # is still open, so it can be reused later (e.g. in calibrate(), after
        # the window has been closed) instead of hardcoding 1920x1080.
    ...
    def calibrate(self, numPoints = 5):
        ...
        try:
            ...
            quit()
        core.wait(.2)
        # Reuse the resolution detected in __init__ instead of hardcoding 1920x1080.
